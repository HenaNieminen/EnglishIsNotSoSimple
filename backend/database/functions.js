    ...
    if (error) {
        ...
        db.serialize(() => {
            ...
            db.run(
                ...
                (48.06758506482741, 12.861964171339462), (60.6052916862764, 27.3852162494234),
                (53.588091911425124, -0.6550705893012161), (34.20733533875285, -84.14022370224356),
                (27.83455218219923, 112.52018317063849)`,
                (error) => {
                    if (error) {
